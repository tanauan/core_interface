...
SC_MODULE(feed_input) {
  ...
  SC_CTOR(feed_input) {
	...
	lanes[0].open("test_cases/dump_mii_rx_0.txt");
  if (lanes[0].is_open()){
	...
	lanes[1].open("test_cases/dump_mii_rx_1.txt");
	if (lanes[1].is_open()){
	...
	lanes[2].open("test_cases/dump_mii_rx_2.txt");
  if (lanes[2].is_open()){
	...
	lanes[3].open("test_cases/dump_mii_rx_3.txt");
  if (lanes[3].is_open()){
